...
export async function setAuthState(isAuthenticated: boolean, userId?: string): Promise<void> {
  await sendMessage({ type: "SET_AUTH_STATE", payload: { isAuthenticated, userId } })
}
